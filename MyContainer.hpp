...
namespace ariel { // Namespace ariel to encapsulate classes and functions
    ...
    class MyContainer {
    private:
        std::vector<T> data;  // Vector to store container elements // וקטור לאחסון האיברים

    public:
        /**
         * @throws None
         */
        MyContainer() = default;  // Default constructor // בנאי ברירת מחדל
         ...
         * @throws None
         */
        void addElement(const T& value) {  // Add an element to the container // הוספת איבר לקונטיינר
         ...
         */
        void removeElement(const T& value) {  // Remove an element from the container // הסרת איבר מהקונטיינר
         ...
         * @throws None
         */
        size_t size() const {  // Return the number of elements // גודל הקונטיינר
         ...
         * @throws None
         */
        const std::vector<T>& getData() const {  // Get container data // החזרת נתוני הקונטיינר
         ...
         */
        // Print all elements
        friend std::ostream& operator<<(std::ostream& os, const MyContainer<T>& container) {  // Stream output operator // הדפסת כל האיברים
         ...
         * @throws None
         */
        AscendingOrderIterator<T> begin_ascending_order() const {  // Begin iterator for ascending order // התחלת סריקה בסדר עולה
         ...
         * @throws None
         */
        AscendingOrderIterator<T> end_ascending_order() const {  // End iterator for ascending order // סיום סריקה בסדר עולה
         ...
         * @throws None
         */
        DescendingOrderIterator<T> begin_descending_order() const {  // Begin iterator for descending order // התחלת סריקה בסדר יורד
         ...
         * @throws None
         */
        DescendingOrderIterator<T> end_descending_order() const {  // End iterator for descending order // סיום סריקה בסדר יורד
         ...
         * @throws None
         */
        SideCrossOrderIterator<T> begin_side_cross_order() const {  // Begin iterator for side-cross order // התחלת סריקה בסדר צידי
         ...
         * @throws None
         */
        SideCrossOrderIterator<T> end_side_cross_order() const {  // End iterator for side-cross order // סיום סריקה בסדר צידי
         ...
         * @throws None
         */
        ReverseOrderIterator<T> begin_reverse_order() const {  // Begin iterator for reverse order // התחלת סריקה בסדר הפוך
         ...
         * @throws None
         */
        ReverseOrderIterator<T> end_reverse_order() const {  // End iterator for reverse order // סיום סריקה בסדר הפוך
         ...
         * @throws None
         */
        OrderIterator<T> begin_order() const {  // Begin iterator for insertion order // התחלת סריקה בסדר הכנסה
         ...
         * @throws None
         */
        OrderIterator<T> end_order() const {  // End iterator for insertion order // סיום סריקה בסדר הכנסה
         ...
         * @throws None
         */
        MiddleOutOrderIterator<T> begin_middle_out_order() const {  // Begin iterator for middle-out order // התחלת סריקה בסדר אמצע-החוצה
         ...
         * @throws None
         */
        MiddleOutOrderIterator<T> end_middle_out_order() const {  // End iterator for middle-out order // סיום סריקה בסדר אמצע-החוצה
